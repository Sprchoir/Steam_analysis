...
**Highlights**  
- Core engagement and popularity metrics (playtime, recent play, owners, reviews, CCU) are highly collinear, indicating they all capture a shared underlying construct: overall game popularity.
...
- The good-review ratio is only moderately correlated with scale metrics, suggesting that perceived quality is not the primary driver of popularity.
...
- Strong multicollinearity among core metrics suggests the need for feature reduction (e.g., selecting representative variables or applying PCA) when building predictive models.
...
**Notes**  
- Longer average playtime strongly correlates with lower effective price per hour, indicating that perceived value is driven more by engagement than by list price.
...
- Across all price bands, the relationship between engagement and sentiment is structurally similar: reviews improve with early engagement, stabilize, and then slightly taper at very high playtimes.
...
**Notes**  
- Lifetime playtime strongly predicts recent activity, but many long-time players still churn, indicating that historical engagement is helpful but not sufficient for retention.
- Games with higher recent median playtime tend to have higher CCU, especially when moving from very low to moderate playtime, though the impact shows diminishing returns at higher levels.
...
**Notes**  
- Games’ recent play share shows only a weak relationship with positive review share; the curves remain largely flat across all price bands.
- Free titles exhibit slightly lower average positive review rates compared with paid games.
- Games with extremely high recent play share (near 100 percent) tend to show a mild drop in review positivity, likely reflecting early-lifecycle volatility.
- Most games cluster near zero recent play share, underscoring the strong long-tail nature of player engagement. 
...
**Notes**  
- Games with larger review volumes tend to have higher and more stable positive-review shares. Low-volume titles show highly variable positivity, ranging from nearly 0 to 100 percent.
...
- Ownership ranges overlap heavily across review categories, with no simple monotonic trend. Extremely positive and extremely negative games both include some large-audience titles, while mid-tier negative games tend to have smaller player bases.
...
- Casual and Puzzle titles skew toward short-session experiences. They appear frequently but show lower median playtime and moderate pricing, reflecting lighter engagement patterns compared to heavier narrative or multiplayer genres.
